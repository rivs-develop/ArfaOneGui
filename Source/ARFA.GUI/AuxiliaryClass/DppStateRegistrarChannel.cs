...
{
    //public sealed class DppStateRegistrarChannel : ISenderChannel, IReceiverChannel, ICommunicationChannel
    //{
    //    private readonly Queue<object> _deque = new Queue<object>();
    //    private bool _isRunning;
    //    internal DppStateRegistrarChannel()
    //    {
    //        Open();
    //    }
