...
{
    //public sealed class XrayStateRegistrarChannel : ISenderChannel, IReceiverChannel, ICommunicationChannel
    //{
    //    private readonly Queue<object> _deque = new Queue<object>();
    //    private bool _isRunning;
    //    internal XrayStateRegistrarChannel()
    //    {
    //        Open();
    //    }
