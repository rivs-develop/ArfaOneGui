...
{
    /// <summary>
    /// Логика взаимодействия для CuvetteBlock10View.xaml
    /// </summary>
    public partial class CuvetteBlock10View : UserControl
    {
        ...
        public CuvetteBlock10View()
        {
            InitializeComponent();
            _lstPath = new List<System.Windows.Shapes.Path>();
            _lstButton = new List<Button>();
            Loaded += CuvetteBlock10View_Loaded;
        }

        private void CuvetteBlock10View_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            var vm = (CuvetteBlock10ViewModel)DataContext;
