...
{
    /// <summary>
    /// Логика взаимодействия для CuvetteBlock15View.xaml
    /// </summary>
    public partial class CuvetteBlock15View : UserControl
    {
        ...
        public CuvetteBlock15View()
        {
            InitializeComponent();
            _lstPath = new List<System.Windows.Shapes.Path>();
            _lstButton = new List<Button>();
            Loaded += CuvetteBlock15View_Loaded;
        }

        private void CuvetteBlock15View_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            var vm = (CuvetteBlock15ViewModel)DataContext;
